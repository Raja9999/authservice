package com.srikanth.authorization.controller;
...
import com.srikanth.authorization.clients.WalletClient;
import com.srikanth.authorization.model.AuthenticationRequest;
import com.srikanth.authorization.model.AuthenticationResponse;
import com.srikanth.authorization.model.User;
import com.srikanth.authorization.service.UserDetailsServices;
import com.srikanth.authorization.util.JwtUtil;
...
public class UserAuthenticationController {
	...
	@ResponseBody
	@JsonIgnoreProperties(ignoreUnknown = true)
	public ResponseEntity<Object> editUser(@RequestHeader("Authorization") String token, @RequestParam("user") String user1,@RequestParam("imageFile") Optional<MultipartFile>  file) throws IOException  {
	...
	@PostMapping("/getName")
	public ResponseEntity<?> extractId(@RequestHeader("Authorization") String token){
	...
	public ResponseEntity<Object> getUser(@RequestHeader("Authorization") String token, @PathVariable String user) {
		if(validateToken(token.substring(7)).getStatusCodeValue()==200) {
